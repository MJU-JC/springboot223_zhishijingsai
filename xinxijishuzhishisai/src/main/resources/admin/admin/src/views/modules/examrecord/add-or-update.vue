    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="测卷名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="测卷名称" clearable  :readonly="ro.exampaperName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="测试编号" prop="examrecordUuidNumber">
                        <el-input v-model="ruleForm.examrecordUuidNumber"
                                  placeholder="测试编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="测试编号" prop="examrecordUuidNumber">
                            <el-input v-model="ruleForm.examrecordUuidNumber"
                                      placeholder="测试编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    insertTime: [
                        { required: true, message: '测试时间不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
