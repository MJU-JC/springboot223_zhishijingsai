    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="测卷名称" prop="exampaperName">
                        <el-input v-model="ruleForm.exampaperName"
                                  placeholder="测卷名称" clearable  :readonly="ro.exampaperName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="测卷名称" prop="exampaperName">
                            <el-input v-model="ruleForm.exampaperName"
                                      placeholder="测卷名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="测试时长(分钟)" prop="exampaperDate">
                        <el-input v-model="ruleForm.exampaperDate"
                                  placeholder="测试时长(分钟)" clearable  :readonly="ro.exampaperDate"></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="测卷总分数" prop="exampaperMyscore">
                        <el-input v-model="ruleForm.exampaperMyscore"
                                  placeholder="测卷总分数" clearable value='0' readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="测卷状态" prop="exampaperTypes">
                        <el-select v-model="ruleForm.exampaperTypes" placeholder="请选择测卷状态">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="测卷状态" prop="exampaperValue">
                            <el-input v-model="ruleForm.exampaperValue"
                                      placeholder="测卷状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    exampaperName: [
                        { required: true, message: '测卷名称不能为空', trigger: 'blur' },
                    ],
                    exampaperDate: [
                        { required: true, message: '测试时长(分钟)不能为空', trigger: 'blur' },
                    ],
                    exampaperMyscore: [
                        { required: true, message: '测卷总分数不能为空', trigger: 'blur' },
                    ],
                    exampaperTypes: [
                        { required: true, message: '测卷状态不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
