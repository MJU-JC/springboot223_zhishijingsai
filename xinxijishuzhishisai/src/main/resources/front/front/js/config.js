...
var indexNav = [
    ...
    {
        name: '在线学习',
        url: './pages/chongwuxihu/list.html'
    },
    {
        name: '测卷表',
    ...
    {
        name: '赛事信息',
        url: './pages/shaishi/list.html'
    }

]

var adminurl =  "http://localhost:8080/xinxijishuzhishisai/admin/dist/index.html#/login";
